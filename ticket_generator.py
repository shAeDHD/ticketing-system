...
def generate_tickets( number_of_tickets ): #NOTE: need to use self?
    ...
    def generate_random_activity( shipment_date_value ):
        ...
        # Random iteration product selection        
        product_category = category[random.randint( 0, len(category) -1 )]
        
        # Random generation of iterations activity type
        if activity_type == "Other / Message":
            ...
            return {
                ...
                "product" : products([product_category],[random.randint( 0, (len(product_category) -1) )])
            }
...
print(tickets.append( generate_tickets( 2 ) ))